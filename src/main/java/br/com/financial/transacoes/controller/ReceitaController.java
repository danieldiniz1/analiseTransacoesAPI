...
import br.com.financial.transacoes.controller.dto.ReceitaCriadaDTO;
...
import br.com.financial.transacoes.service.ReceitaService;
...
public class ReceitaController {
    ...
    @ResponseBody
    public ResponseEntity<ReceitaCriadaDTO> cadastroReceita(@RequestBody @Valid ReceitaForm receitaForm){
        ...
        receitaService.adicionar(receitaForm);
        return ResponseEntity.status(204).body(new ReceitaCriadaDTO());
    }
}
